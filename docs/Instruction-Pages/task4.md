...
![Cell B highlighted](image-22.png "Cell B highlighted")
...
![Hello entered in B1](image-23.png "Hello entered in B1")
4. Click back on **cell B1**—notice how the text looks off-center because of the extra spaces.
![Hello Text poorly formatted](image-24.png "Hello Text poorly formatted")
...
![Trim whitespace shown in menu](image-25.png "Trim whitespace shown in menu")
9. Wait for the **pop-up notification** to appear, telling you how many cells were cleaned.
![Trim whitespace confirmation page](image-26.png "Trim whitespace confirmation page")
