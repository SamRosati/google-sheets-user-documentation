...
![Spreadsheet scrolled down demonstrating Freeze row functionality](image-20.png "Spreadsheet scrolled down demonstrating Freeze row functionality")
...
![Menu opened to unfreeze rows](image-21.png "Menu opened to unfreeze rows")
