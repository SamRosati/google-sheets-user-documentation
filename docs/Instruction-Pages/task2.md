...
![Spreadsheet with data is column A](image-7.png "Spreadsheet with data is column A")
...
![Data highlighted, and format menu open](image-8.png "Data highlighted, and format menu open")
4. Scroll down and select **Alternating colors**.
![Alternating colors selected](image-9.png "Alternating colors selected")
5. Observe the **Alternating colors** settings panel that appears on the right side of the screen.
![Alternating colors panel open](image-10.png "Alternating colors panel open")
6. Under the **Styles** section, click on a color preset (e.g., Blue, Green, or Grey) that matches your preference.
![Color panels open, option to select color](image-11.png "Color panels open, option to select color")
7. Check the box labeled **Header** if your top row contains titles or labels.
![Header checkbox checked in color panel](image-12.png "Header checkbox checked in color panel")
8. Check the box labeled **Footer** if you want the very last row to have a distinct summary color.
![Footer checkbox checked in color panel](image-13.png "Footer checkbox checked in color panel")
9. Review the "Apply to range" box at the top of the panel to ensure it covers your entire dataset.
![Apply to range section of alternating colors panel shown](image-14.png "Apply to range section of alternating colors panel shown")
10. Click the **Done** button at the bottom of the side panel to save your changes.
![Selecting Done](image-15.png "Selecting Done")
